...
<div id="MrPlanPlugin" class="wrap">
    ...
    <h2><?php echo esc_html__('Booking engine for activities', 'misterplan'); ?></h2>
    ...
    <form method="POST" id="MrPlanMotorForm" action="admin.php?page=mrplan_admin&id_motor=<?php echo (int) (!is_null($motor) ? $motor->id_motor : 0); ?>&accion=guardar_motor">
        <div class="row">
            ...
            <div class="col-6 col-md-2">                        
                <label>
                    <div>
                        <?php echo esc_html__('Activity ID', 'misterplan'); ?>
                    ...
                    <span class="TMrPlanPlugin_Help"><?php echo esc_html__('MisterPlan activity identifier', 'misterplan'); ?></span>
                </label>
            </div>
            <div class="col-6 col-md-2">                        
                <label>
        ...
        <div class="row">
            ...
            <div class="col-3 text-center">
                <label>
                    <img src="<?php echo esc_attr($dir_plugin); ?>assets/images/admin/tipo_2_completa.png" style="width: 100%; max-width: 200px); display:block;">
                    ...
                    <?php echo esc_html__('Complete'); ?> (<?php echo esc_html__('Booking engine', 'misterplan'); ?> + <?php echo esc_html__('Information', 'misterplan'); ?>)
                </label>
            </div>

            <div class="col-3 text-center">
                <label>
                    <img src="<?php echo esc_attr($dir_plugin); ?>assets/images/admin/tipo_2_simple.png" style="width: 100%; max-width: 200px); display:block;">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-2">                        
                <label>
                    ...
                    <input type="number"  name="ancho_maximo" placeholder="<?php echo esc_html__('Max width', 'misterplan'); ?>" value="{%if motor.datos.ancho_maximo>300%}<?php if(isset($motor->datos->ancho_maximo)) echo esc_attr($motor->datos->ancho_maximo); ?>{%endif%}"  style="width:100%;" min="400">
                </label>
            </div>
            <div class="col-12">
                <br>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <input type="hidden" name="id_motor" value="<?php if(!is_null($motor)) echo esc_attr($motor->id_motor); ?>">
